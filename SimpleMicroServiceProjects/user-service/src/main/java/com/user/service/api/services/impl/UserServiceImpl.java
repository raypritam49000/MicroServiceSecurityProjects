...
import com.user.service.api.utility.PasswordEncoder;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDTO createUser(UserDTO userDTO) {
        userDTO.setPasswordHash(PasswordEncoder.hashPassword(userDTO.getPasswordHash()));
    ...
    public UserDTO updateUserById(String userId, UserDTO userDto) {
        ...
        existUser.setPasswordHash(PasswordEncoder.hashPassword(userDto.getPasswordHash()));
